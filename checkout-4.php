            ...
            <section class="section-checkout shipping-form confirm-section">
                <div class="container">
                    ...
                    <div class="phase-title passed">
                        <h1><a href="checkout-1.php">1.Check out process</a></h1>
                    </div>

                    <div class="phase-title passed">
                        <h1><a href="checkout-2.php">2.Shipping address</a></h1>
                    </div>

                    <div class="phase-title passed">
                        <h1><a href="checkout-3.php">3.Payment methods</a></h1>
                    </div>

                    <div class="phase-title current">
                        <h1><a href="checkout-4.php">4.Account and billing details</a></h1>
                    </div>
                    <form action="checkout-4.php" method="post" />
                        ...
                        <div class="form-holder">
                            ...
                            <div class="row-fluid details-row">
                                <div class="span4">
                                    ...
                                    <a class="cusmo-btn narrow" href="checkout-3.php">modify</a>
                                    </div>
                                </div>
                                <div class="span4">
                                    <div class="info-box">
                           ...
                           <div class="buttons-holder">
                                <a class="cusmo-btn narrow gray" href="checkout-3.php">back</a>
                ...
                <div class="disabled-phases">
                    ...
                    <div class="phase-title">
                        <h1><a href="checkout-5.php">5.Confirm orders</a></h1>
                    </div>
                </div>
